### **Podcasts**
some of these are on YouTube too, i don't really bother separating them. ⭐ represents particular faves, ask me IRL
...
**Commentators/ML Eng's**
    - ⭐️ Nathan Lambert's Interconnects [https://www.interconnects.ai/](https://www.interconnects.ai/) is high quality
    - ⭐️ Semi Analysis [https://www.semianalysis.com/p/ai-server-cost-analysis-memory-is](https://www.semianalysis.com/p/ai-server-cost-analysis-memory-is) (but expensive. listen to [our pod](https://twitter.com/swyx/status/1725599896483553480) with him)
    - Alan Thompson's Life Architect [](https://lifearchitect.substack.com/)[https://lifearchitect.substack.com](https://lifearchitect.substack.com) (note [his credentials sus](https://news.ycombinator.com/item?id=35588974))
    - Bradley Metrock (Deepgram) [https://thisweekinvoice.substack.com/](https://thisweekinvoice.substack.com/)
    - Carlos's Data Machina [https://datamachina.substack.com/](https://datamachina.substack.com/)
    - Davis Blalock Arxiv roundup [https://dblalock.substack.com/](https://dblalock.substack.com/)
    - [https://www.supervised.news/](https://www.supervised.news/) is new but promising quality
    - [https://nextword.substack.com/](https://nextword.substack.com/) is new but promising quality
    - [https://www.aitidbits.ai/about](https://www.aitidbits.ai/about) is new but promising quality
    - PulseMCP (official MCP registry) [https://www.pulsemcp.com/newsletter](https://www.pulsemcp.com/newsletter)
...
**Aggregators**
    ...
    - Amplify/Sarah Catanzaro's PTK [https://www.amplifypartners.com/projects-to-know](https://www.amplifypartners.com/projects-to-know)
    - Ben's Bites [https://bensbites.beehiiv.com/](https://bensbites.beehiiv.com/)
    - TheSequence [https://thesequence.substack.com/about](https://thesequence.substack.com/about)
    - Rachel Woods' The AI Exchange [https://theaiexchange.beehiiv.com/](https://theaiexchange.beehiiv.com/)
    - Lior's AlphaSignal [https://alphasignal.ai/](https://alphasignal.ai/)
    - Rowan Cheung's Rundown AI [https://www.therundown.ai/](https://www.therundown.ai/)
    - Bot Eat Brain [https://www.boteatbrain.com/](https://www.boteatbrain.com/)
    - [https://codingwithintelligence.com/](https://codingwithintelligence.com/) (new but promising)
    - [https://www.neatprompts.com/subscribe](https://www.neatprompts.com/subscribe) (recommended by Software Defined Talk #428)
    - [https://generallyintelligent.substack.com/](https://generallyintelligent.substack.com/) (daily bitesize news)
    - TLDR AI [https://tldr.tech/ai](https://tldr.tech/ai) (daily aggregator with focus on research and big tech)
    - [https://latent.space/](https://latent.space/) has a monthly news recap, but i am also [incubating a daily one](https://buttondown.email/ainews)

---
### **other lists i like**
- this one [https://x.com/jesslionness/status/1910394910219657409](https://x.com/jesslionness/status/1910394910219657409)

#### **Roundup-type newsletters, stay in the loop**
- -[@AlphaSignalAI](https://x.com/AlphaSignalAI) tracks new model releases 
- -[@tldrai](https://x.com/tldrai) AI news, some business, some research, some engineering resources 
- -[@bensbitesdaily](https://x.com/bensbitesdaily) daily newsletter, keeps track of all the little stuff announced, has some good building with AI tips too, nice roundup of AI tools 
- -[@AiBreakfast](https://x.com/AiBreakfast) AI projects/products/news (weekly roundup) 
- -[@chiefaioffice](https://x.com/chiefaioffice) tracks AI startup funding 
- -[@Smol_AI](https://x.com/Smol_AI) a hero newsletter, tracks all the chatter in AI discords + reddits + X etc

#### **Technical newsletters**
- NLP Newsletter by [@omarsar0](https://x.com/omarsar0) overview of the top AI papers of the week (I try to read almost all the papers they list, but you can get away with just reading the description and still learn a lot), and if you pay the premium version they also do weekly roundups of agents
- Deep (Learning) Focus by [@CameronWolfe](https://x.com/CameronWolfe) - very technical, deep dive into ML & AI concepts. This is a must read for any engineer trying to understand AI better IMO
- Davis Summarizes Papers by [@davisblalock](https://x.com/davisblalock) - incredible roundup of ML arXiv submissions -[@SemiAnalysis_](https://x.com/SemiAnalysis_) by [@dylan522p](https://x.com/dylan522p) - keep tabs with what's going on in the AI hardware layer and semiconductors
- Deep Learning Weekly ([@dl_weekly](https://x.com/dl_weekly)) - name says it all, really - great weekly aggregator of all things deep learning

#### **Analysis/Commentary Newsletters**
-[@AISupremacyNews](https://x.com/AISupremacyNews) super thoughtful commentary, I always learn a lot / makes me think

- AI Pioneers at Work by [@jesslionness](https://x.com/jesslionness) (aka me!) - MY NEWSLETTER!! :) I'll post link in the comments -[@latentspacepod](https://x.com/latentspacepod) by [@FanaHOVA](https://x.com/FanaHOVA) & [@swyx](https://x.com/swyx) amazing interviews with AI builders, you can read newsletter and/or listen to the podcast. I don't think you can be an AI engineer without being a Latent Space fan!!